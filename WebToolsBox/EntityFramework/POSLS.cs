...
namespace WebToolsBox.EntityFramework
{
    ...
    public partial class POSLS
    {
        ...
        public Nullable<short> ROUTER { get; set; }
        public Nullable<short> APP_TYPE { get; set; }
        public string MSG_TYPE { get; set; }
        public string PROC_CODE { get; set; }
        public string MSG_CODE { get; set; }
        public string PBOC_DATA { get; set; }
        public string TERM_RD_ABLILITY { get; set; }
        public string CARD_CON_CODE { get; set; }
        public string CARD_SEQ_NUM { get; set; }
        public string SERVER_CODE { get; set; }
        public string MODE1 { get; set; }
        public string AID { get; set; }
        public string APP_TABLE { get; set; }
        public string TSI { get; set; }
        public string ACQ_BANK_ID { get; set; }
